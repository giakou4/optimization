function [a,b,calls,x1,x2] = myGolden(f,a0,b0,l,KMAX)
% function [a,b,x1,x2] = myGolden(f,a0,b0,l,KMAX)
% MYGOLDEN finds the minimum of a function inside an interval. The 
